...
st.set_page_config(page_title='Servicio de Microbiología - Hospital de Pediatría S.A.M.I.C. "Prof. Dr. Juan P. Garrahan"', 
page_icon="/home/usuario/Downloads/Laura/boletin_epidemio/img/virus.png", layout="wide")
...
st.sidebar.image('/home/usuario/Downloads/Laura/boletin_epidemio/img/logo_garrahan.png', width=200)
...
st.sidebar.markdown('El objetivo del mismo es reconocer la situación actual de estos eventos en la población que concurre al hospital y contribuir, de esta forma, con la toma de decisiones.')
st.sidebar.markdown('La fuente de información utilizada para la elaboración de este análisis son los datos extraídos del sistema informático hospitalario SIG-HG.') 
